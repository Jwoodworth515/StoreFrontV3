...
namespace MVC3.UI.MVC.Utilities
{
    public class ImageUtility
    {
        ...
        internal static void ResizeImage(object savePath, object file, Image convertedImage, int maxImageSize, int maxThumbSize)
        {
            throw new NotImplementedException();
        }

        internal static void ResizeImage(string savePath, object file, Image convertedImage, int maxImageSize, int maxThumbSize)
        {
            throw new NotImplementedException();
        }
